...
- 「マージできない理由を調べて」
- 「ブランチ保護に合わせて運用したい」
- `bootstrap-repository` などの整理系 Skill から、PR 作成フェーズだけを引き継ぐとき
...
- 整理系 Skill で行った変更の仕上げ担当として、commit、push、PR、CI 確認を引き受ける。

## 標準ワークフロー

1. `scripts/pr-precheck.sh` で状態確認（branch/status/remotes）。
2. 必要なら作業ブランチを作成。
